...
const babelLoaderConfiguration = {
  ...
  include: [
    ...
    path.resolve(appDirectory, 'node_modules/clamp'),
    path.resolve(appDirectory, 'node_modules/invariant'),
    ...
    path.resolve(appDirectory, 'node_modules/react-navigation-tabs-stack'),
